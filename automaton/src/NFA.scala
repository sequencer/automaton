 ...
 *
 * */
case class eNFA[State, Symbol](initialState: State,
...
case class NFA[State, Symbol](initialState: Set[State],
  ...
  private lazy val cleanMultiEdge: NFA[State, Symbol] = {
    if (multiEdge.isEmpty) this else new NFA[State, Symbol](
      initialState = initialState,
      transition = {
        multiEdge.foldLeft(Set[((Set[State], Symbol), Set[Set[State]])]()) {
          (l, r) => {
            l ++ (r match {
      ...
      finalStates = finalStates).cleanMultiEdge
  }
